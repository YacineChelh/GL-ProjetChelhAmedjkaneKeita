...
public class Database {
    ...
    public void insertReservation(Timestamp debutReserv, Timestamp finReserv, String etatReservation, Integer idClient, Object idBorne, Object idFacturation) {
        ...
        try (Connection connection = DatabaseParam.getConnection();
            ...
            statement.setInt(5, (Integer) idBorne);
            statement.setInt(6, (Integer) idFacturation);
